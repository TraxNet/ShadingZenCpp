...
{
	shz::math::vector<shz::math::f32, 4> v  = shz::math::vector<shz::math::f32, 4>(0.f);
...
{
	shz::math::vector<shz::math::f32, 4> v = shz::math::vector<shz::math::f32, 4>(1.4f);
	BOOST_CHECK(is_aligned(&v, 16));
	v += 0.4f;
	...
	shz::math::vector<shz::math::f32, 4> w = shz::math::vector<shz::math::f32, 4>(-1.4f);
	v += w;
...
BOOST_AUTO_TEST_CASE(vector4fDivs)
{
	...
	shz::math::vector<shz::math::f32, 4> w = shz::math::vector<shz::math::f32, 4>(2.f);
	v /= w;
...
{
	shz::math::vector<shz::math::f32, 4> v = shz::math::vector<shz::math::f32, 4>(1.4f);
	shz::math::vector<shz::math::f32, 4> w = shz::math::vector<shz::math::f32, 4>(0.5f);
...
{
	shz::math::vector<shz::math::f32, 4> v = shz::math::vector<shz::math::f32, 4>(1.4f);
	BOOST_CHECK_CLOSE(v.sqrtlength(), 2.8f, 0.01f);
	BOOST_CHECK_CLOSE(v.length(), 7.84f, 0.00001f);
}
...
BOOST_AUTO_TEST_CASE(vector4fNormalize)
{
	...
	BOOST_CHECK_CLOSE(w.data[0], 0.5f,  0.00001f);
	BOOST_CHECK_CLOSE(w.data[1], 0.5f,  0.00001f);
}
